...
{
	unsigned long* suspend_switch = 0x40bded08;
#ifdef CONFIG_NEEDS_MANUAL_RELOC
	int i;
#endif
	    puts("BOOT method : ");
		    if( *suspend_switch==0xabcd )
			{
				*suspend_switch = 0;
		        puts("Fast system launching\n");
		        cleanup_before_linux();
				puts("ready for linux\n");
		        asm volatile("movw r0, #0xeee8");
		        asm volatile("movt r0, #0x406a");
